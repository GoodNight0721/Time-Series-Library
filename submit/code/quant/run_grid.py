...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--strategy-mode", choices=["one_bar", "stateful"], default="one_bar")
    parser.add_argument("--ma-window", type=int, default=0)
    parser.add_argument("--min-hold-bars", type=int, default=1)
    parser.add_argument("--hold-until-opposite", action="store_true")
